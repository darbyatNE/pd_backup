        ...
        <div className="absolute right-4 sm:right-6 lg:right-8 top-full z-30 mt-1 w-[560px] max-w-[calc(100vw-2rem)] rounded-xl border border-slate-200 bg-white shadow-lg">
          ...
          <div className="p-3 max-h-[60vh] overflow-y-auto">
            ...
            {/* Peak scope — on/off-peak use the NERC 5×16 calendar (non-holiday
                ...
                Presets and the Custom HE range sit on their own rows so the HE
                selects don't get pinched when the presets fill the width. */}
            {!isProfileView && (
              <div className="border-t border-slate-100 mt-3 pt-3 space-y-2">
                ...
                {/* Row 2 — custom hour-ending range */}
                <div className="flex items-center gap-2 text-xs flex-wrap">
